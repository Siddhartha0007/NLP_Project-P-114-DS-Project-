# -*- coding: utf-8 -*-
"""
Created on Sat May 21 18:12:22 2022
...
html_temp = """
    ...
    <h2 style="color:white;text-align:center;">Streamlit Document Classifier</h2>
    </div>
    """
...
st.write(resume_data.category.unique())
...
st.sidebar.subheader('Category Plot')
st.sidebar.pyplot(p)
